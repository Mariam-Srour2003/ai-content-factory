...
class VectorStoreHybrid:
    def __init__(self, persist_directory: Optional[Path] = None):
        ...
        # raw chromadb client (for admin / list / delete_collection / reset)
    ...
    def add_documents(self, collection_name: str, texts: List[str], metadatas: List[Dict[str,Any]], ids: Optional[List[str]] = None):
        vs = Chroma(collection_name=collection_name, embedding_function=self.lc_embedding, persist_directory=self.persist_dir)
